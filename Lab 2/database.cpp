...
void Database::update_new_entries(Database *&router_1, Database *&router_2,
				  Table_iterator *&iter_1, Table_iterator *&iter_2)
{
...
void Database::unique_host(Database *router_1, Database *router_2,
		           Table_iterator *iter_1, Table_iterator *iter_2)
{
  ...
  update_new_entries(router_1, router_2, iter_1, iter_2);
...
void Database::fill_table(Database *router_1, Database *router_2,
		          Table_iterator *iter_1, Table_iterator *iter_2)
{
...
void Database::share_table(Database *router_1, Database *router_2)
{
  ...
  fill_table(router_1, router_2, &iter_1, &iter_2);
