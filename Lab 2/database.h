...
class Database
{
 ...
 public:
  ...
  void share_table(Database * router_1, Database *router_2);
 ...
 private:
  ...
  /* Internal helper function to add an entry found in the route table of
     ...
     table of 'router_1' */
  void update_new_entries(Database *&router_1, Database *&router_2,
			  Table_iterator *&iter_1, Table_iterator *&iter_2);
  ...
  void unique_host(Database *router_1, Database *router_2,
		     Table_iterator *iter_1, Table_iterator *iter_2);
  ...
  void fill_table(Database *router_1, Database *router_2,
		  Table_iterator *iter_1, Table_iterator *iter_2);
