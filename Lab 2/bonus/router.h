...
class Router : public Local_network, public Database
{
 ...
 private:
  ...
  /* Internal helper function to print a message showing which router
     ('router_1') is forwarding a message and who to ('router_2'). The function
     outputs the integer address of each router as part of the output string */
  void print_forwarding_message(const Database *router_1,
